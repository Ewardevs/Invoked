      ...
      <div className="relative z-10 flex items-center h-full px-10">
        <div className="max-w-lg">
          ...
          <p className="mt-4">
            ...
            ciencia y una ácida personalidad, y su mejor amigo es Taiju, que es
            muy buena persona pero más apto para usar los músculos que para
            pensar...
          </p>
